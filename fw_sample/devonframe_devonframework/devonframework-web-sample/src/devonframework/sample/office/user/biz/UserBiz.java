...
package devonframework.sample.office.user.biz;
...
public class UserBiz {
	...
	public LMultiData retrieveUserList(LData input) throws LException {

		LMultiData result = new LMultiData();
		LCommonDao dao = new LCommonDao("user/retrieveUserList", input, "default");

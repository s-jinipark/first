				...
				<article class="widget">
	                ...
	                <table class="table">
	                    ...
	                    <tbody id="employeeArea">
                    		...
                    		%>
                    			<tr>
	                    			<td><%=resultList.get("num", idx) %></td>
	                                <td><%=resultList.get("name", idx) %></td>
	                                <td><%=resultList.get("joblevelCodeName", idx) %></td>
	                                <td><%=resultList.get("skillCodeName", idx) %></td>
	                                <td><%=resultList.get("telephone", idx) %></td>
	                                <td><%=resultList.get("birthdate", idx) %></td>
                    			</tr>
                    		<%
	                    	}
	                    	%>
